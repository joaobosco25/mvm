...
const LAWYERS=[
  {id:'rafaella',short:'Dra. Rafaella Vasconcelos',name:'Dra. Rafaella Silva de Vasconcelos',oab:'OAB/MG 250.459',image:'assets/rafaela.png',text:'Atendimento jurídico personalizado, pautado pela responsabilidade, transparência e atenção às particularidades de cada caso. Com o propósito de compreender as necessidades de cada cliente, analisar cuidadosamente as questões apresentadas e oferecer soluções jurídicas claras e estratégicas, com acompanhamento próximo durante todo o processo.'},
